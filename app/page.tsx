...
const SECTIONS: { title: string; subtitle: string; readings: ReadingCard[] }[] = [
  ...
  },
  {
    ...
    readings: [
      {
        icon: "☽", name: "Moon Reading", price: "$5", color: "#a5b4fc",
        glow: "rgba(165,180,252,0.3)", border: "rgba(165,180,252,0.25)",
      ...
      {
        icon: "✦", name: "Natal Chart Reading", price: "$10", color: "#fbbf24",
  ...
  },
  {
    ...
    readings: [
      {
        icon: "✋", name: "Palm Reading", price: "$10", color: "#c8d4e8",
      ...
      {
        icon: "🌈", name: "Aura Photo Reading", price: "$12", color: "#818cf8",
  ...
  },
  {
    ...
    readings: [
      {
        icon: "☁", name: "Dream Interpretation", price: "$12", color: "#a5b4fc",
        glow: "rgba(165,180,252,0.3)", border: "rgba(165,180,252,0.25)",
...
function ReadingCard({ icon, name, price, color, glow, border, tagline, desc, href }: ReadingCard) {
  ...
  return (
    <div style={{ minHeight: "100vh", display: "flex", flexDirection: "column", alignItems: "center", position: "relative", zIndex: 1 }}>
      ...
      <div style={{ width: "100%", maxWidth: 720, textAlign: "center", padding: "56px 24px 48px", display: "flex", flexDirection: "column", alignItems: "center" }}>
        ...
        <p style={{ fontFamily: "'EB Garamond', serif", fontSize: 15, color: "#6a5a8a", lineHeight: 1.7, maxWidth: 440, margin: "0 auto 40px", fontStyle: "italic" }}>
