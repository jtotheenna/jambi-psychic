...
export const SPREADS: SpreadType[] = [
  ...
  },
  {
    ...
    positions: ["Who you are in this connection", "Who they are in this connection", "What is between you", "What is unspoken", "Where this is heading"],
    description: "Five cards for any relationship — romantic, friendship, family",
    bestFor: ["relationship", "friendship", "us", "between us", "him and me", "her and me", "we"],
  },
  {
    name: "The Hidden Truth",
    positions: ["What you see", "What you are missing", "What is hidden from you", "What is actually possible"],
    description: "Four cards for seeing clearly when something feels unclear",
    bestFor: ["what am i missing", "hidden", "not seeing", "blind spot", "can't figure out", "what is really"],
  },
  {
    name: "The Letting Go",
    positions: ["What you are holding", "Why you are holding it", "What it is costing you", "What releases when you let go", "What comes after"],
    description: "Five cards for releasing — grief, relationships, old versions of yourself",
    bestFor: ["letting go", "move on", "can't let go", "still holding", "grief", "loss", "release", "forgive"],
  },
  {
    name: "The Career Path",
    positions: ["Where you stand now", "What you bring to the table", "What is blocking you", "What opportunity is approaching", "What to do next"],
    description: "Five cards for work, career, and purpose",
    bestFor: ["career", "job", "work", "business", "money", "purpose", "calling", "quit", "stay or leave"],
  },
  {
    name: "The Inner Child",
    positions: ["What the child in you needs", "What they are afraid of", "What they never got", "What you can give them now", "How this changes everything"],
    description: "Five cards for deep healing and self-understanding",
    bestFor: ["inner child", "childhood", "mother", "father", "parents", "growing up", "old wound", "never healed"],
  },
  {
    name: "The New Beginning",
    positions: ["What is ending", "What you are bringing with you", "What to leave behind", "What is waiting for you", "The first step"],
    description: "Five cards for starting over — new city, new chapter, new self",
    bestFor: ["new beginning", "fresh start", "starting over", "new chapter", "what's next", "moving", "starting"],
  },
  {
    name: "The Dream Reading",
    positions: ["The central symbol", "What it represents in your waking life", "The emotion underneath", "What your deeper self is telling you", "What to do with this message"],
    description: "Five cards for interpreting a dream or recurring symbol",
    bestFor: ["dream", "nightmare", "symbol", "keeps appearing", "recurring"],
  },
  {
    name: "The Body and Soul",
    positions: ["What your body is carrying", "What your mind is carrying", "What your spirit needs", "What is draining you", "What will restore you", "The medicine"],
    description: "Six cards for exhaustion, burnout, and deep tiredness",
    bestFor: ["tired", "exhausted", "burnout", "drained", "depleted", "no energy", "overwhelmed", "too much"],
  },
  {
    name: "The Fork in the Road",
    positions: ["Option one — what it offers", "Option one — what it costs", "Option two — what it offers", "Option two — what it costs", "What you actually want", "What will guide you"],
    description: "Six cards when you have two clear options and can't choose",
    bestFor: ["two options", "either or", "a or b", "which one", "both options", "can't decide between"],
  },
  {
    name: "The Ancestral Thread",
    positions: ["What was passed down to you", "What you carry without knowing", "What you are healing in your lineage", "What breaks the pattern", "What you pass forward"],
    description: "Five cards for family patterns, inherited wounds, and breaking cycles",
    bestFor: ["family pattern", "generational", "ancestors", "cycle", "break the cycle", "my family", "inherited"],
  },
  {
    name: "The Year Ahead",
